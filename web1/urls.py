...
from Tivly.views import login, merchantInfo,accountInfo,aboutUs,howto,jobs,contact,deleteAccount,logout,home,callback,newDiscoveries,recommendation,businessInfo,getOffer, youSure
