...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'MyRewards.reward'
        db.delete_column('Tivly_myrewards', 'reward_id')
    ...
    def backwards(self, orm):
        ...
        # User chose to not deal with backwards NULL issues for 'MyRewards.reward'
        raise RuntimeError("Cannot reverse this migration. 'MyRewards.reward' and its values cannot be restored.")
