...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('Tivly_businesses', (
            ...
            ('businessName', self.gf('django.db.models.fields.CharField')(max_length=20)),
            ...
            ('pictureLocation', self.gf('django.db.models.fields.CharField')(max_length=50)),
        ...
        db.create_table('Tivly_cards', (
            ...
            ('typeString', self.gf('django.db.models.fields.CharField')(max_length=20)),
        ))
        ...
        db.create_table('Tivly_myrecommendations', (
            ...
            ('businessID', self.gf('django.db.models.fields.CharField')(max_length=40)),
            ('rID', self.gf('django.db.models.fields.CharField')(max_length=6)),
            ('recID', self.gf('django.db.models.fields.CharField')(max_length=30)),
            ...
            ('reccsID', self.gf('django.db.models.fields.CharField')(max_length=6, null=True, blank=True)),
        ))
