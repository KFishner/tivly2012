...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'RewardHistory'
        db.create_table('Tivly_rewardhistory', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('csID', self.gf('django.db.models.fields.CharField')(max_length=6)),
            ('reccomendedBy', self.gf('django.db.models.fields.CharField')(max_length=6)),
            ('reward', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['Tivly.Rewards'])),
            ('dateUsed', self.gf('django.db.models.fields.DateField')(null=True, blank=True)),
        ))
        db.send_create_signal('Tivly', ['RewardHistory'])

        # Adding model 'UniqueRewardHistory'
        db.create_table('Tivly_uniquerewardhistory', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('csID', self.gf('django.db.models.fields.CharField')(max_length=6)),
            ('reccomendedBy', self.gf('django.db.models.fields.CharField')(max_length=6)),
            ('reward', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['Tivly.Rewards'])),
        ...
        db.send_create_signal('Tivly', ['UniqueRewardHistory'])

        # Adding model 'UniqueBusinessHistory'
        db.create_table('Tivly_uniquebusinesshistory', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('csID', self.gf('django.db.models.fields.CharField')(max_length=6)),
            ('reward', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['Tivly.Rewards'])),
            ('dateUsed', self.gf('django.db.models.fields.DateField')(null=True, blank=True)),
        ...
        db.send_create_signal('Tivly', ['UniqueBusinessHistory'])


    def backwards(self, orm):
        # Deleting model 'RewardHistory'
        db.delete_table('Tivly_rewardhistory')

        # Deleting model 'UniqueRewardHistory'
        db.delete_table('Tivly_uniquerewardhistory')

        # Deleting model 'UniqueBusinessHistory'
        db.delete_table('Tivly_uniquebusinesshistory')
