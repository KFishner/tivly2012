...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'FBUser.date_joined'
        db.alter_column('Tivly_fbuser', 'date_joined', self.gf('django.db.models.fields.DateField')(null=True))

    def backwards(self, orm):

        # User chose to not deal with backwards NULL issues for 'FBUser.date_joined'
        raise RuntimeError("Cannot reverse this migration. 'FBUser.date_joined' and its values cannot be restored.")
