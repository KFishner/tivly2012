...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Businesses.saturdayHours'
        db.alter_column('Tivly_businesses', 'saturdayHours', self.gf('django.db.models.fields.CharField')(max_length=20))

        # Changing field 'Businesses.thursdayHours'
        db.alter_column('Tivly_businesses', 'thursdayHours', self.gf('django.db.models.fields.CharField')(max_length=20))

        # Changing field 'Businesses.wednesdayHours'
        db.alter_column('Tivly_businesses', 'wednesdayHours', self.gf('django.db.models.fields.CharField')(max_length=20))

        # Changing field 'Businesses.mondayHours'
        db.alter_column('Tivly_businesses', 'mondayHours', self.gf('django.db.models.fields.CharField')(max_length=20))

        # Changing field 'Businesses.fridayHours'
        db.alter_column('Tivly_businesses', 'fridayHours', self.gf('django.db.models.fields.CharField')(max_length=20))

        # Changing field 'Businesses.sundayHours'
        db.alter_column('Tivly_businesses', 'sundayHours', self.gf('django.db.models.fields.CharField')(max_length=20))

        # Changing field 'Businesses.tuesdayHours'
        db.alter_column('Tivly_businesses', 'tuesdayHours', self.gf('django.db.models.fields.CharField')(max_length=20))

    def backwards(self, orm):

        # Changing field 'Businesses.saturdayHours'
        db.alter_column('Tivly_businesses', 'saturdayHours', self.gf('django.db.models.fields.CharField')(max_length=10))

        # Changing field 'Businesses.thursdayHours'
        db.alter_column('Tivly_businesses', 'thursdayHours', self.gf('django.db.models.fields.CharField')(max_length=10))

        # Changing field 'Businesses.wednesdayHours'
        db.alter_column('Tivly_businesses', 'wednesdayHours', self.gf('django.db.models.fields.CharField')(max_length=10))

        # Changing field 'Businesses.mondayHours'
        db.alter_column('Tivly_businesses', 'mondayHours', self.gf('django.db.models.fields.CharField')(max_length=10))

        # Changing field 'Businesses.fridayHours'
        db.alter_column('Tivly_businesses', 'fridayHours', self.gf('django.db.models.fields.CharField')(max_length=10))

        # Changing field 'Businesses.sundayHours'
        db.alter_column('Tivly_businesses', 'sundayHours', self.gf('django.db.models.fields.CharField')(max_length=10))

        # Changing field 'Businesses.tuesdayHours'
        db.alter_column('Tivly_businesses', 'tuesdayHours', self.gf('django.db.models.fields.CharField')(max_length=10))
