...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Businesses.zipCode'
        db.add_column('Tivly_businesses', 'zipCode',
                      self.gf('django.db.models.fields.IntegerField')(default=181802),
                      keep_default=False)


    def backwards(self, orm):

        # User chose to not deal with backwards NULL issues for 'Businesses.zip'
        raise RuntimeError("Cannot reverse this migration. 'Businesses.zip' and its values cannot be restored.")
        # Deleting field 'Businesses.zipCode'
        db.delete_column('Tivly_businesses', 'zipCode')
