...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'CardSpringUser.emailed'
        db.add_column('Tivly_cardspringuser', 'emailed',
    ...
    def backwards(self, orm):
        ...
        # Deleting field 'CardSpringUser.emailed'
        db.delete_column('Tivly_cardspringuser', 'emailed')
