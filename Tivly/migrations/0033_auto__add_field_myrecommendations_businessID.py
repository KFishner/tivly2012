...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'MyRecommendations.businessID'
        db.add_column('Tivly_myrecommendations', 'businessID',
                      self.gf('django.db.models.fields.CharField')(default='l5sxg80QSa7O', max_length=40),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'MyRecommendations.businessID'
        db.delete_column('Tivly_myrecommendations', 'businessID')
