...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'MyRecommendations.received'
        db.delete_column('Tivly_myrecommendations', 'received')

        # Deleting field 'MyRecommendations.redeemed'
        db.delete_column('Tivly_myrecommendations', 'redeemed')


    def backwards(self, orm):
        # Adding field 'MyRecommendations.received'
        db.add_column('Tivly_myrecommendations', 'received',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'MyRecommendations.redeemed'
        db.add_column('Tivly_myrecommendations', 'redeemed',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)
