...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'MyRewards.reccomendedBy'
        db.add_column('Tivly_myrewards', 'reccomendedBy',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=6),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'MyRewards.reccomendedBy'
        db.delete_column('Tivly_myrewards', 'reccomendedBy')
