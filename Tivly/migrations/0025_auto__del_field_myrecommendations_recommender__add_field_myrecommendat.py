...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'MyRecommendations.recommender'
        db.delete_column('Tivly_myrecommendations', 'recommender')
        ...
        # Adding field 'MyRecommendations.reccsID'
        db.add_column('Tivly_myrecommendations', 'reccsID',
                      self.gf('django.db.models.fields.CharField')(max_length=30, null=True, blank=True),
                      keep_default=False)


        # Changing field 'MyRecommendations.csID'
        db.alter_column('Tivly_myrecommendations', 'csID', self.gf('django.db.models.fields.CharField')(max_length=6, null=True))

    def backwards(self, orm):
        # Adding field 'MyRecommendations.recommender'
        db.add_column('Tivly_myrecommendations', 'recommender',
                      self.gf('django.db.models.fields.CharField')(default='void', max_length=30),
                      keep_default=False)

        # Deleting field 'MyRecommendations.recID'
        db.delete_column('Tivly_myrecommendations', 'recID')

        # Deleting field 'MyRecommendations.reccsID'
        db.delete_column('Tivly_myrecommendations', 'reccsID')


        # Changing field 'MyRecommendations.csID'
        db.alter_column('Tivly_myrecommendations', 'csID', self.gf('django.db.models.fields.CharField')(default='void', max_length=6))
    ...
    models = {
        ...
        'Tivly.myrecommendations': {
            ...
            'reccsID': ('django.db.models.fields.CharField', [], {'max_length': '30', 'null': 'True', 'blank': 'True'})
        },
        'Tivly.myrewards': {
