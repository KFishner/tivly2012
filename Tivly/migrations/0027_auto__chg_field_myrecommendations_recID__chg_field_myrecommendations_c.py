...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'MyRecommendations.recID'
        db.alter_column('Tivly_myrecommendations', 'recID', self.gf('django.db.models.fields.CharField')(max_length=30))

        # Changing field 'MyRecommendations.csID'
        db.alter_column('Tivly_myrecommendations', 'csID', self.gf('django.db.models.fields.CharField')(default='', max_length=6))

        # Changing field 'MyRecommendations.reccsID'
        db.alter_column('Tivly_myrecommendations', 'reccsID', self.gf('django.db.models.fields.CharField')(max_length=6, null=True))

    def backwards(self, orm):

        # Changing field 'MyRecommendations.recID'
        db.alter_column('Tivly_myrecommendations', 'recID', self.gf('django.db.models.fields.CharField')(max_length=6))

        # Changing field 'MyRecommendations.csID'
        db.alter_column('Tivly_myrecommendations', 'csID', self.gf('django.db.models.fields.CharField')(max_length=6, null=True))

        # Changing field 'MyRecommendations.reccsID'
        db.alter_column('Tivly_myrecommendations', 'reccsID', self.gf('django.db.models.fields.CharField')(default='', max_length=30))
